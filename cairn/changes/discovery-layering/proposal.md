...
## What
Adopt a boundary rule, a discovery mechanism belonging to whichever library owns the RFC that defines it (spec-defined discovery in the domain library, heuristic or cross-domain in io-pim-discovery), and make the resource fix typed in two halves:
